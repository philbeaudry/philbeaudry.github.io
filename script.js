...
let imgCheese; // Spiderman Mask Filter
...
function draw()
{
  ...
  {
    case '-1': break;
    case '0': drawCheeseMask(); break;
    // case '1': drawDogFace(); break;
  }
}

// Cheese Mask Filter
function drawCheeseMask()
{
  ...
  if (positions !== false)
  {
    ...
    translate(-wx/2, -wy/2);
    image(imgCheese, positions[62][0], positions[62][1], wx, wy); // Show the mask at the center of the face
    pop();
  }
}
